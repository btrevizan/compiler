...
|	   	     type TK_IDENTIFICADOR initialization				{ $$ = $3; implicit_conversion($1, $$->children[0]); add_identifier(peek(scope), $1, $2, LOCAL); add_lexeme($$, $2); instr_list = make_code_store_assign(scope, $2, $3); };
...
assignment: id '=' expr			{ implicit_conversion($1->type, $3); $$ = binary_node($2, $1, $3); $$->type = $1->type; instr_list = make_code_store(scope, $1, $3); };
...
term: directTerm		{ $$ = $1; instr_list = make_code_load(scope, $$); }
|     call			{ $$ = $1; };
